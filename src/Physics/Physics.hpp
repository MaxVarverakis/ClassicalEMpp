...
public:
    ...
    // Constructor for 2D
    Physics(std::size_t& dim, double& bound, std::size_t& numPoints);
    ...
    Physics(std::size_t& dim, double& bound, std::size_t& numPoints, std::vector<ChargedParticle3D>& particles);
